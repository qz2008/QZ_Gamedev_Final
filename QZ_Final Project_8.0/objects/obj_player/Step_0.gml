  ...
  if(room = rm_5_classhallway_1)
  {
	...
	if (!audio_is_playing(snd_studentgossip_speedygonzo))
    {
     ...
     if(Marks >0)
     {
      ...
      {
	        wordshurt = "Students: Too fat!";
	        words = "Moonzi: Please.";
       }
        if(place_meeting(x,y,obj_fstudent2))
       {
	       wordshurt = "Students: Too thin!";
	       words = "Moonzi: Don’t leave me.";
       }
        if(place_meeting(x,y,obj_mstudent1))
       {
	       wordshurt = "World: Tomboy?";
	       words = "Moonzi: What did I do wrong?";
        }
        if(place_meeting(x,y,obj_mstudent2))
       {
	       wordshurt = "Students: Whore?";
...
if(room = rm_11_midpark)
  ...
  {
	  if(place_meeting(x,y,obj_mstudent1)|| place_meeting(x,y,obj_mstudent2)|| place_meeting(x,y,obj_fstudent2)|| place_meeting(x,y,obj_fstudent1))
	  {
		   wordshurt = "";
	       words = "Press Y to observe.";
  ...
  if(room = rm_18_nightmare)
  {
	  ...
	  {
		  if(nightmareindex > 2 ||nightmareindex = 2)
		  {
